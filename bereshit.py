...
class BoxCollider:
   ...
   def check_collision(self, other):
       ...
       def generate_face_to_face_contact(ref_center, ref_axes, ref_half, inc_center, inc_axes, inc_half, normal_axis,
           ...
           return final_points,planes,incident_face
       ...
       # normal = contact_points[1] if contact_points is not None else contact_point
       # smallest_overlap = contact_points[2] if contact_points is not None else contact_point
       ...
       return ref,contact_point, normal, smallest_overlap,[ref_face_center,incident_face]
   ...
   def Stage3(self, children, dt):
       ...
       for i in range(len(children)):
           ...
           for j in range(i + 1, len(children)):
               ...
               ref, contact_point, normal, penetration, arr = result
               rb1, rb2 = rb11, rb2
               ref_face_center, incident_face = arr[0],arr[1]
