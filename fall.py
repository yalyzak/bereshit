...
obj_small = Object(position=(0,1,    0), size=(1, 1, 1),rotation=(0,0,0),name='obj_small')
obj_big = Object(position=(0, 6,    0), size=(1, 3, 1),rotation=(0,0,0),name='obj_big')

joint = Object(position=(0, 5,    0), size=(1, 1, 1),name='joint')
floor = Object(position=(0,-1,10),size=(100,1,100),rotation=(0,0,0),name='floor')
floor2 = Object(position=(0,10 ,10),size=(100,1,100),rotation=(0,0,0),name='floor')
...
joint.add_component(Rigidbody(useGravity=False))
...
floor2.add_component(Rigidbody(isKinematic=True,velocity=Vector3(0,0,0),restitution=r))
floor2.add_component(BoxCollider())
...
Core.run(scene,gizmos=False,scriptRefreshRate=1)